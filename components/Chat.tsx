      ...
      <div id='chat-box' className=''>
        ...
        <div className='chat-message'>
          <div className='chat-message-content'>
            <p className='user-name' style={{color: "green"}}>tommyBoy22:</p>
            <p className='user-msg'>Hey, how are you?</p>
          </div>
          <div className='chat-message-content'>
            <p className='user-name' style={{color: "red"}}>james:</p>
            <p className='user-msg'>LETS GOOO</p>
          </div>
          <div className='chat-message-content'>
            <p className='user-name' style={{color: "blue"}}>ToTheMoon69:</p>
            <p className='user-msg'>Diamond handing since day 1!</p>
          </div>
          <div className='chat-message-content'>
            <p className='user-name' style={{color: "yellow"}}>DiamondApe:</p>
